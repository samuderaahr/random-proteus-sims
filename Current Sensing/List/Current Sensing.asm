...
; 0000 0034 // Func7=In Func6=In Func5=In Func4=In Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 0035 // State7=T State6=T State5=P State4=P State3=0 State2=0 State1=0 State0=0
; 0000 0036 PORTB=0x30;
	LDI  R30,LOW(48)
	OUT  0x18,R30
; 0000 0037 DDRB=0b11001111;
	LDI  R30,LOW(207)
	OUT  0x17,R30
; 0000 0038 
...
; 0000 004D // Clock value: 15.625 kHz
; 0000 004E // Mode: Ph. correct PWM top=0x03FF
; 0000 004F // OC1A output: Non-Inv.
; 0000 0050 // OC1B output: Non-Inv.
...
; 0000 0057 TCCR1A=0xA3;
	LDI  R30,LOW(163)
	OUT  0x2F,R30
; 0000 0058 TCCR1B=0x05;
	LDI  R30,LOW(5)
	OUT  0x2E,R30
...
_0x6:
; 0000 008D {
; 0000 008E   result = read_adc(0);
	LDI  R30,LOW(0)
	ST   -Y,R30
	RCALL _read_adc
	MOVW R4,R30
; 0000 008F   OCR1A = result;
	__OUTWR 4,5,42
; 0000 0090   OCR1B = result;
	__OUTWR 4,5,40
; 0000 0091   if (result < last)
	__CPWRR 4,5,6,7
	BRSH _0x9
; 0000 0092   {
; 0000 0093     PORTB.0 = 1;  //reverse
	SBI  0x18,0
; 0000 0094     PORTB.3 = 1;
	SBI  0x18,3
; 0000 0095     delay_ms((last - result)*3);
	MOVW R26,R6
	SUB  R26,R4
	SBC  R27,R5
	LDI  R30,LOW(3)
	...
	ST   -Y,R30
	RCALL _delay_ms
; 0000 0096     PORTB.0 = 0;  //reverse
	CBI  0x18,0
; 0000 0097     PORTB.3 = 0;
	CBI  0x18,3
; 0000 0098   }
; 0000 0099   last = result;
_0x9:
	MOVW R6,R4
; 0000 009A }
	RJMP _0x6
