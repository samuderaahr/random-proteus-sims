...
; 0000 007C // USART Receiver: Off
; 0000 007D // USART Transmitter: On
; 0000 007E // USART Mode: Asynchronous
; 0000 007F // USART Baud Rate: 1000
; 0000 0080 UCSRA=0x00;
	OUT  0xB,R30
; 0000 0081 UCSRB=0x08;
	LDI  R30,LOW(8)
	OUT  0xA,R30
; 0000 0082 UCSRC=0x86;
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 0083 UBRRH=0x01;
	LDI  R30,LOW(1)
	OUT  0x20,R30
; 0000 0084 UBRRL=0xF3;
	LDI  R30,LOW(243)
	OUT  0x9,R30
; 0000 0085 
...
_0x6:
; 0000 009B       {
; 0000 009C          adc_val = read_adc(0);
	LDI  R30,LOW(0)
	ST   -Y,R30
	RCALL _read_adc
	MOVW R4,R30
; 0000 009D          itoa(adc_val,strink);
	ST   -Y,R5
	ST   -Y,R4
	ST   -Y,R7
	ST   -Y,R6
	RCALL _itoa
; 0000 009E          puts(strink);
	ST   -Y,R7
	ST   -Y,R6
	RCALL _puts
; 0000 009F          putsf("\n\r");
