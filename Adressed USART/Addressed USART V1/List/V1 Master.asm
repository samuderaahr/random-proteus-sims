...
_0x0:
	.DB  0x4A,0x41,0x4E,0x25,0x30,0x33,0x64,0x43
	.DB  0x4F,0x4B,0x0
__RESET:
	CLI
	CLR  R30
...
;#include <stdio.h>
;
;#define CALL1 PORTB.1
;#define CALL2 PORTB.2
;
...
; 0000 0027 
; 0000 0028 // Crystal Oscillator division factor: 1
; 0000 0029 #pragma optsize-
; 0000 002A CLKPR=0x80;
	LDI  R30,LOW(128)
	OUT  0x26,R30
; 0000 002B CLKPR=0x00;
	LDI  R30,LOW(0)
	OUT  0x26,R30
...
; 0000 0032 // Func2=In Func1=In Func0=In
; 0000 0033 // State2=T State1=T State0=T
...
; 0000 0049 TCCR0A=0x00;
	OUT  0x30,R30
; 0000 004A TCCR0B=0x00;
	OUT  0x33,R30
...
; 0000 0067 // INT0: Off
; 0000 0068 // INT1: Off
; 0000 0069 // Interrupt on any change on pins PCINT0-7: Off
...
; 0000 0078 // USART Receiver: Off
; 0000 0079 // USART Transmitter: On
; 0000 007A // USART Mode: Asynchronous
; 0000 007B // USART Baud Rate: 300
; 0000 007C UCSRA=0x00;
	OUT  0xB,R30
; 0000 007D UCSRB=0x08;
	LDI  R30,LOW(8)
	OUT  0xA,R30
; 0000 007E UCSRC=0x06;
	LDI  R30,LOW(6)
	OUT  0x3,R30
; 0000 007F UBRRH=0x01;
	LDI  R30,LOW(1)
	OUT  0x2,R30
; 0000 0080 UBRRL=0xA0;
	LDI  R30,LOW(160)
	OUT  0x9,R30
; 0000 0081 
